...
console.log(typeof +"17"); // number (унарный плюс приводит любое значение к числу)
console.log(17 - "1"); // 16 (автоматическое приведение типов, работает со всеми, кроме "+")
...
// 1 способ Умножить и потом разделить
...
console.log(multiRound1(Math.PI)); // [3, 3, 4, 3, 3.14]
...
// Если нужно работать с числами, выходящими за пределы безопасного диапазона, 
